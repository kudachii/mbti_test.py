...
def run_imperial_32type_app():
    ...
    "ISFP": {
        "name": "冒険家", "animal": "ネコ",
        "desc_A": "感性豊かな表現者。今この瞬間を楽しみ、自分の美学に自信を持って自由に世界を彩ります。",
        "desc_T": "繊細な芸術家肌。自分の作品や感性が調和しているかを深く考え、独自の完璧な世界観を構築します。"
    },
    "ESTP": {
        "name": "起業家", "animal": "チーター",
        "desc_A": "エネルギッシュな挑戦者。リスクを恐れず、自分の直感と行動力を信じてチャンスを確実にモノにします。",
        "desc_T": "抜け目ない勝負師。状況の変化を敏感に察知し、最善の選択をするために神経を研ぎ澄ませている人です。"
    },
    "ESFP": {
        "name": "エンターテイナー", "animal": "レッサーパンダ",
        "desc_A": "天性のスター。人を喜ばせる自分を愛し、その場を明るくする圧倒的な社交エネルギーを持っています。",
        "desc_T": "心を癒すパフォーマー。周囲が本当に楽しんでいるかを敏感に感じ取り、場を盛り上げる努力を惜しみません。"
    }
}

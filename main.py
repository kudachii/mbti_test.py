...
def run_mbti_diagnostic():
    ...
    mbti_db = {
        ...
        "ESTP": {
            "name": "起業家", "animal": "勇敢なチーター", "catchphrase": "「考える前に跳べ。直感とスピードで世界を制す」",
            "mentor": "ツンデレな指導員",
            "details": {
                "work": "リスクを恐れず、現場の課題を即決・即実行で解決する『トラブルシューター』。デスクワークは死ぬほど退屈。",
                "love": "情熱的でストレート。スリルや楽しさを共有できる相手を求めるけど、束縛されると一瞬で冷めるわ。",
                "stress": "普段の余裕がなくなり、目先の刺激に依存。無謀な暴走をして、周囲をヒヤヒヤさせることも。",
                "best_match": "冷静なサメ（ISTP）"
            },
            "messages": {"ギャル先生": "チーターくん、爆速すぎ！ブチ上げてこー！🐆✨"}
        },
        "ESFP": {
            "name": "エンターテイナー", "animal": "陽気なレッサーパンダ", "catchphrase": "「一瞬で場を彩る、愛されキャラの天才」",
            "mentor": "ギャル先生",
            "details": {
                "work": "周囲を巻き込んで明るい雰囲気を作る『ムードメーカー』。実務よりも、人と関わる仕事で才能が爆発するわ。",
                "love": "今この瞬間の楽しさを全力で楽しむタイプ。サプライズ大好きだけど、一人の時間が長くなると不安で病んじゃう。",
                "stress": "孤独感に耐えられなくなり、被害妄想が激化。『自分は嫌われている』と思い込んで周囲を疑い始めるわ。",
                "best_match": "自由なネコ（ISFP）"
            },
            "messages": {"ギャル先生": "パンダちゃん、最高にハッピー！アゲてこ！🐼💖"}
        },
        "ENFP": {
            "name": "広報運動家", "animal": "天真爛漫なカワウソ", "catchphrase": "「無限のワクワクを撒き散らす、愛の伝道師」",
            "mentor": "ギャル先生",
            "details": {
                "work": "溢れるアイデアで人を惹きつける『クリエイター』。やりたいことが多すぎて、詰めが甘くなるのが玉にキズ。",
                "love": "運命の糸を信じるタイプ。相手の可能性を誰よりも信じ、全力で応援するけど、ルーチンな付き合いは飽きちゃう。",
                "stress": "些細なことに執着するようになり、強迫観念に囚われるわ。普段の自由な発想が消えて、ガチガチに固まっちゃう。",
                "best_match": "理想を夢見るウサギ（INFP）"
            },
            "messages": {"ギャル先生": "カワウソちゃん、ワクワク全開！冒険しよ！🦦"}
        },
        "ENTP": {
            "name": "討論者", "animal": "独創的なキツネ", "catchphrase": "「知的なイタズラで、退屈な世界に風穴を開ける」",
            "mentor": "ツンデレな指導員",
            "details": {
                "work": "常識を疑い、新しい可能性を見つける『イノベーター』。議論が大好きだけど、相手を論破しすぎて敵を作ることも。",
                "love": "知的な駆け引きを楽しむ。マンネリが大嫌いで、常に新しい刺激や議論を求めるけど、実は寂しがり屋な一面も。",
                "stress": "普段の論理性が崩れ、些細なデータや事実に異常に執着し始める。自分を正当化するために、偏屈な理屈をこねるわ。",
                "best_match": "孤高のトラ（INTJ）"
            },
            "messages": {"ギャル先生": "キツネくん、天才！常識ブチ壊そ！🦊🔥"}
        },
        "ESTJ": {
            "name": "幹部", "animal": "誠実な番犬", "catchphrase": "「揺るぎない正義感で、秩序と平和を守り抜く」",
            "mentor": "論理的なビジネスコーチ",
            "details": {
                "work": "組織をまとめ上げる『完璧なリーダー』。効率と結果を重視し、怠慢な態度には容赦なく雷を落とすわ。",
                "love": "将来を見据えた堅実な付き合いを好む。頼りがいがあるけど、自分の価値観を押し付けすぎて相手を疲れさせることも。",
                "stress": "誰にも理解されない孤独感に襲われ、急に涙もろくなったり感情を爆発させるわ。周りに当たり散らすことも。",
                "best_match": "穏やかなシカ（ISFJ）"
            },
            "messages": {"ギャル先生": "ワンちゃん、リーダーシップマジリスペクト！🐕"}
        },
        "ESFJ": {
            "name": "領事", "animal": "お世話好きなゾウ", "catchphrase": "「大きな愛でみんなを包む、コミュニティの守護神」",
            "mentor": "優しさに溢れるメンター (Default)",
            "details": {
                "work": "調和を重んじ、全員が心地よく動けるように整える『守護者』。感謝されることが最大のモチベーションよ。",
                "love": "家庭的で安定感抜群。相手に尽くすことに幸せを感じるけど、見返りがないと『冷たい』とヘソを曲げることも。",
                "stress": "理屈っぽい批判に弱くなり、普段の優しさが消えて過激な言葉を吐くわ。とにかく誰かに肯定してほしい状態に。",
                "best_match": "勤勉なビーバー（ISTJ）"
            },
            "messages": {"ギャル先生": "ゾウさん、優しさMAX！いつもありがと！🐘💖"}
        },
        "ENFJ": {
            "name": "主人公", "animal": "情熱的なライオン", "catchphrase": "「みんなの可能性を信じ、光差す方へ導く太陽」",
            "mentor": "頼れるお姉さん",
            "details": {
                "work": "共感力とカリスマ性で人を導く『火付け役』。理想が高すぎて、ついてこれないメンバーが出てしまうのが悩み。",
                "love": "理想のパートナーシップを追求する。相手を成長させようと熱心になるけど、それが時にお節介に感じられることも。",
                "stress": "批判を受けると『自分はダメな人間だ』と激しく沈み込む。普段の自信が嘘のように消えて、周囲の目を過剰に気にするわ。",
                "best_match": "思慮深いフクロウ（INFJ）"
            },
            "messages": {"ギャル先生": "ライオンくん、情熱ヤバい！救われるよ！🦁✨"}
        },
        "ENTJ": {
            "name": "指揮官", "animal": "威風堂々なワシ", "catchphrase": "「高みから未来を見据え、勝利への最短距離を飛ぶ」",
            "mentor": "論理的なビジネスコーチ",
            "details": {
                "work": "圧倒的な決断力と実行力を持つ『指揮官』。無能な仕組みを破壊し、最短で目標を達成するわ。",
                "love": "切磋琢磨し合える対等な関係を好む。デートも戦略的だけど、相手の感情的なニーズを見落としがちなのが弱点。",
                "stress": "自分のコントロールを失うと情緒不安定に。些細なことで怒鳴ったり、逆に極端に悲観的になったりと波が激しくなるわ。",
                "best_match": "探求するチンパンジー（INTP）"
            },
            "messages": {"ギャル先生": "ワシさん、最強リーダー！世界征服しよー！🦅🔥"}
        }
    }

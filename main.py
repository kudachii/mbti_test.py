...
def run_imperial_32type_app():
    ...
    "INTJ": {"name": "建築家", "animal": "トラ", "match": "ENTP",
             "desc_A": "揺るぎない自信を持つ戦略家。独自のビジョンを冷徹なまでに遂行し、目標を達成します。",
             "desc_T": "向上心の塊である完璧主義者。自分の理論が正しいか絶えず検証し、高みを目指します。"},
    "INTP": {"name": "論理学者", "animal": "チンパンジー", "match": "ENTJ",
             "desc_A": "知的な自由人。自分の知性に自信を持ち、周囲の評価を気にせず独創的な発想を楽しみます。",
             "desc_T": "真理を追究する思索家。自分の考えに不備がないか自問自答し、緻密な論理を組み立てます。"},
    "ENTJ": {"name": "指揮官", "animal": "ワシ", "match": "INTP",
             "desc_A": "圧倒的な威厳を持つリーダー。困難を恐れず、最短距離で勝利を掴む決断力があります。",
             "desc_T": "緻密な戦略を練る司令官。目標達成への情熱が強く、常に改善の余地を模索し続けます。"},
    "ENTP": {"name": "討論者", "animal": "キツネ", "match": "INTJ",
             "desc_A": "恐れ知らずの革命児。議論を楽しみ、新しいアイデアを次々と形にする行動力があります。",
             "desc_T": "機知に富んだ探究者。自分のアイデアが万全か批判的に検討し、洗練された解決策を追求します。"},
    "INFJ": {"name": "提唱者", "animal": "フクロウ", "match": "ENFJ",
             "desc_A": "自信に満ちた導き手。自分の信念に迷いがなく、理想の世界を実現するために行動します。",
             "desc_T": "感受性豊かな提唱者。心の機微を鋭く察知し、完璧な理想を求めて内省する精神性を持ちます。"},
    "INFP": {"name": "仲介者", "animal": "ウサギ", "match": "ENFP",
             "desc_A": "自分を肯定できる理想主義者。独自の価値観を大切にし、自分らしく生きる人です。",
             "desc_T": "心優しき完璧主義者。理想と現実のギャップに悩みつつも、深い共感と美学を持ちます。"},
    "ENFJ": {"name": "主人公", "animal": "ライオン", "match": "INFJ",
             "desc_A": "カリスマ的な導き手。周囲を元気づける才能に溢れ、皆を明るい未来へ導きます。",
             "desc_T": "献身的な平和主義者。他人の幸せを心から願い、自分が役立っているかを常に気遣います。"},
    "ENFP": {"name": "広報運動家", "animal": "カワウソ", "match": "INFP",
             "desc_A": "自由を愛する冒険家。自分の感性を信じ、新しい可能性に飛び込むエネルギーがあります。",
             "desc_T": "共感力の高い表現者。周囲の反応に敏感で、皆が楽しめる場所を作るために配慮を欠かしません。"},
    "ISTJ": {"name": "管理者", "animal": "ビーバー", "match": "ESFJ",
             "desc_A": "揺るぎない実務家。伝統と秩序を重んじ、自分のやり方に自信を持って責任を果たします。",
             "desc_T": "几帳面な仕事人。ミスがないか細部までチェックし、正確さで周囲の信頼を勝ち取ります。"},
    "ISFJ": {"name": "擁護者", "animal": "シカ", "match": "ESTJ",
             "desc_A": "落ち着きのある守護者。周囲を支える自分の役割を誇りに思い、安定した包容力を持ちます。",
             "desc_T": "細やかな配慮の達人。大切な人のために最善を尽くし、常に改善点を探す努力家です。"},
    "ESTJ": {"name": "幹部", "animal": "番犬", "match": "ISFJ",
             "desc_A": "堂々とした組織運営者。規律を重視し、迷いのない決断でチームを統率します。",
             "desc_T": "責任感の塊。社会的な規範を完璧に守ろうと努め、細部まで行き届いた管理を行います。"},
    "ESFJ": {"name": "領事", "animal": "ゾウ", "match": "ISTJ",
             "desc_A": "明るい社交界の主役。自分のサービス精神に自信を持ち、心地よい環境を積極的に作ります。",
             "desc_T": "おもてなしの専門家。周囲の期待に応えられているかを常に意識し、和を乱さないよう努めます。"},
    "ISTP": {"name": "巨匠", "animal": "サメ", "match": "ESTP",
             "desc_A": "冷静沈着な技術者。自分のスキルを信頼し、どんなトラブルにも即興で解決する強さがあります。",
             "desc_T": "技を磨く専門職。自分の分析が正確か常に検証し、洗練された手法を追い求めます。"},
    "ISFP": {"name": "冒険家", "animal": "ネコ", "match": "ESFP",
             "desc_A": "感性豊かな表現者。今この瞬間を楽しみ、自分の美学に自信を持って世界を彩ります。",
             "desc_T": "繊細な芸術家肌。自分の感性が調和しているかを深く考え、独自の完璧な世界を構築します。"},
    "ESTP": {"name": "起業家", "animal": "チーター", "match": "ISTP",
             "desc_A": "挑戦者。リスクを恐れず、自分の直感と行動力を信じてチャンスを確実にモノにします。",
             "desc_T": "抜け目ない勝負師。状況の変化を敏感に察知し、最善の選択のために神経を研ぎ澄ませます。"},
    "ESFP": {"name": "エンターテイナー", "animal": "レッサーパンダ", "match": "ISFP",
             "desc_A": "天性のスター。人を喜ばせる自分を愛し、その場を明るくする社交エネルギーを持ちます。",
             "desc_T": "心を癒すパフォーマー。周囲が楽しんでいるかを敏感に感じ、盛り上げる努力を惜しみません。"}
}
